...
if ($.isNode() && process.env.XP_iboxpayHEADER2) {
  ...
  if (
    process.env.XP_iboxpayHEADER2 &&
    process.env.XP_iboxpayHEADER2.indexOf(COOKIES_SPLIT) > -1
  ) {
    middleiboxpayHEADER = process.env.XP_iboxpayHEADER2.split(COOKIES_SPLIT);
  } else {
    middleiboxpayHEADER = process.env.XP_iboxpayHEADER2.split();
  } 
